...
export const clubFactoryUsdgAbi = [
  {
    "type": "function",
    "name": "MAX_DEV_BUY_USDC",
    "inputs": [],
...
export const clubRouterUsdgAbi = [
  {
    "type": "function",
    "name": "buy",
    "inputs": [
      ...
      },
      {
        "name": "permit",
        "type": "tuple",
        "internalType": "struct ClubRouterUsdg.Permit",
        "components": [
          {
            "name": "deadline",
            "type": "uint256",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "invite",
        "type": "tuple",
        "internalType": "struct ClubRouterUsdg.Invite",
        "components": [
          {
            "name": "inviter",
            "type": "address",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "draft",
        "type": "tuple",
        "internalType": "struct ClubAuction.Draft",
        "components": [
          {
            "name": "name",
            "type": "string",
      ...
      },
      {
        "name": "permit",
        "type": "tuple",
        "internalType": "struct ClubAuction.Permit",
        "components": [
          {
            "name": "deadline",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ClubAuction.Club",
        "components": [
          {
            "name": "id",
            "type": "uint256",
